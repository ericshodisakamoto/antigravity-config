...
- now trims whitespaces on selected text (thanks @santosdiogo97)

### 2.3.1

- a new command "open folder of file" opens the folder where the file is located

### 2.3.0

- a new command "open file in new editor beside active" creates a new view column (thanks @matklad)
- fixed removing slash at the beginning of an absolute path (thanks @jmuellercadence)
...
- made some code maintanance
- move context menu position
...
- fixed gitlab issue [#23](https://gitlab.com/fr43nk/seito-openfile/-/issues/23):
